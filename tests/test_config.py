...
from dr.config import check_encrypted_text
from dr.config import get_boolean
from dr.config import get_config_data
from dr.config import get_integer, get_uint
from dr.config import settings
...
class ConfigTester(unittest.TestCase):
    ...
    @patch('dr.config.boto3')
    def test_check_encrypted_text(self, mock_boto3):
        """
        test dr.config.check_encrypted_text
        """
    ...
    @patch('dr.config.settings')
    def test_get_boolean(self, mock_settings):
        """
        test dr.config.get_boolean
        """
        tests = [
    ...
    def test_get_config_data(self):
        """
        test dr.config.get_config_data
        """
    ...
    def test_settings(self):
        ...
        config_dir = os.path.join(upper_path, "dr", "config.yaml")
